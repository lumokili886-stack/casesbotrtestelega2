...
<head>
  ...
  <link rel="icon" href="/assets/icons/favicon.ico?v=20260425-2" sizes="any">
  <link rel="icon" type="image/png" sizes="32x32" href="/assets/icons/favicon-32x32.png?v=20260425-2">
  <link rel="icon" type="image/png" sizes="16x16" href="/assets/icons/favicon-16x16.png?v=20260425-2">
  <link rel="apple-touch-icon" sizes="180x180" href="/assets/icons/apple-touch-icon.png?v=20260425-2">
  <style>
...
<body>
  ...
  <script>
    ...
    function setSection(section){
      const map = ['overview','funnel','users','balance','cases','promocodes','payments','admins'];
    ...
    async function loadDashboard(options = {}){
      ...
      const [me, overview, users, activity, cases, promoCodes, payments] = await Promise.all([
        jfetch('/admin/api/me'),
